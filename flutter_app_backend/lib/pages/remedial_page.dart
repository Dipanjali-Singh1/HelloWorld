...
class RemedialPage extends StatefulWidget {
  const RemedialPage({Key key}) : super(key: key);

  @override
  _RemedialPageState createState() => _RemedialPageState();
}

class _RemedialPageState extends State<RemedialPage> {
                            ...
                            return GestureDetector(
                                onTap: () {
                                  Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                          builder: (context) => DetailRemedialPage(
