...
/*
  ...
  _initData() async {
    await CallApi().getPublicData("allworkshops").then((response) {
      setState(() {
    ...
    return Container(
      ...
      child: SafeArea(
        child: Scaffold(
            ...
            appBar: AppBar(
              toolbarHeight: 20,
              title: Text(workshopinfo[0].title),
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        TextWidget(
                          text: this.workshopinfo[0].title,
                          fontSize: 20,
                 ...
                 //   padding: const EdgeInsets.only(right: 20, left:20),
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          TextWidget(
                            text: this.workshopinfo[0].about_content,
                            fontSize: 16,
                            color: Colors.black,
                          ),
                          Image.network(
                            "http://192.168.46.251/uploads/" +
                                this.workshopinfo[0].img.toString(),
                            fit: BoxFit.contain,
                          ),
                        ],
                      ),
