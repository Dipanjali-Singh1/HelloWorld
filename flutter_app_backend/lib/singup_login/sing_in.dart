        ...
        body: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              TextWidget(
                  text: "USP Skill Me Up", fontSize: 20, isUnderLine: false),
              TextWidget(text: "Welcome!", fontSize: 20, isUnderLine: false),
              SizedBox(height: height * 0.01),
              TextInput(
                  textString: "Email",
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  TextWidget(text: "Sign in", fontSize: 19, isUnderLine: false),
                  GestureDetector(
                      onTap: () {
                        _login();
                      },
