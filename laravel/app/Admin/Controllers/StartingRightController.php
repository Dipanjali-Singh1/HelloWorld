...
class StartingRightController extends AdminController
{
    /**
    ...
    {
        $grid = new Grid(new StartingRight());
    ...
    {
        $show = new Show(StartingRight::findOrFail($id));
    ...
    {
        $form = new Form(new StartingRight());
